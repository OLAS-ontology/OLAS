# Contributing to Ontology of Laboratory Animal Science

The following is a set of guidelines for contributing to OLAS. 
...
Please use our [Issue Tracker](https://github.com/OLAS-ontology/OLAS/issues/) for reporting problems with the ontology. 
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/OLAS-ontology/OLAS/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/OLAS-ontology/OLAS/issues/new/choose).
...
**Process**:
  Check [OLAS editing wiki page](https://github.com/OLAS-ontology/OLAS/wiki/OLAS-Editing)
